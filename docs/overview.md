...
Current documented release: `0.4.4`
...
Consumers can clear all cached raw payloads through `F1Client.clearCache()` and inspect the current cache footprint with `F1Client.cacheSizeInMB()`.
